...
extern int mpi_my_kx_rank;            // rank of the process in a kx direction of parallelization
extern int mpi_my_m_rank;            // rank of the process in Hermite direction of parallelization
...
extern MPI_Comm mpi_kx_comm;          // row communicator (kx direction)
extern MPI_Comm mpi_m_comm;          // column communicator (Hermite direction)
