...
void diag_computeHZSpectrum(const COMPLEX *h);
void diag_initSpec();
void diag_getShells();
...
extern double *diag_kSpecZH;
extern double *diag_kSpecZBpar;
extern double *diag_kSpecZPhi;
extern double *diag_kSpecZBperp;
...
extern double *diag_linearFlux;
extern double *diag_linearFluxInverse;
extern double *diag_linearFluxForward;
